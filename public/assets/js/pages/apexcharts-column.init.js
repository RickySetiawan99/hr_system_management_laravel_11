...
var chart = new ApexCharts(
  document.querySelector("#columnWithDatalabelChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#stackedColumn100Chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#groupedStackedColumnChart"),
  options
);
chart.render();
...
var options = {
  ...
  plotOptions: {
    bar: {
      ...
      dumbbellColors: [
        [
          getChartColorsArray("groupedStackedColumnChart")[0],
          getChartColorsArray("groupedStackedColumnChart")[1],
        ],
      ],
    },
  },
...
var options = {
  ...
  legend: {
    ...
    markers: {
      fillColors: [
        getChartColorsArray("columnMarkersChart")[0],
        getChartColorsArray("columnMarkersChart")[1],
      ],
    },
  },
};
...
var chart = new ApexCharts(
  document.querySelector("#columnMarkersChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#columnGroupLabelChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#columnRotatedLabelChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#columnNegativeValueChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#columnDistributedChart"),
  options
);
chart.render();
