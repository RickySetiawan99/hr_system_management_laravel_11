...
function loadCharts() {
  ...
  if (totalEmployeeColors) {
    ...
    if (totalEmployeeChart != "") totalEmployeeChart.destroy();
    totalEmployeeChart = new ApexCharts(
      document.querySelector("#totalEmployee"),
      options
    );
  ...
  if (totalApplicationColors) {
    ...
    if (totalApplicationChart != "") totalApplicationChart.destroy();
    totalApplicationChart = new ApexCharts(
      document.querySelector("#totalApplication"),
      options
    );
  ...
  if (hiredCandidatesColors) {
    ...
    if (hiredCandidatesChart != "") hiredCandidatesChart.destroy();
    hiredCandidatesChart = new ApexCharts(
      document.querySelector("#hiredCandidates"),
      options
    );
  ...
  if (rejectedCandidatesColors) {
    ...
    if (rejectedCandidatesChart != "") rejectedCandidatesChart.destroy();
    rejectedCandidatesChart = new ApexCharts(
      document.querySelector("#rejectedCandidates"),
      options
    );
  ...
  if (applicationReceivedColors) {
    ...
    if (applicationReceivedChart != "") applicationReceivedChart.destroy();
    applicationReceivedChart = new ApexCharts(
      document.querySelector("#applicationReceivedChart"),
      options
    );
...
var chart = new ApexCharts(
  document.querySelector("#totalProjectChart"),
  options
);
chart.render();
