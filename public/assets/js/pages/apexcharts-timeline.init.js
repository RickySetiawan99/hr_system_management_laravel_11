...
var chart = new ApexCharts(
  document.querySelector("#advancedMultipleRanges"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#multipleSeriesGroupRows"),
  options
);
chart.render();
...
var options = {
  ...
  plotOptions: {
    bar: {
      ...
      dumbbellColors: [
        [
          getChartColorsArray("multipleSeriesGroupRows")[0],
          getChartColorsArray("multipleSeriesGroupRows")[1],
        ],
      ],
    },
  },
