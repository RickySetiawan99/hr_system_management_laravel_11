...
var chart = new ApexCharts(
  document.querySelector("#groupedStackedChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#negativeValuesChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#customDataLabelsChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#barWithImagesChart"),
  options
);
chart.render();
