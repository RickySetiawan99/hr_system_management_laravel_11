...
var chart = new ApexCharts(
  document.querySelector("#pagesInteraction"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#platformPerspective"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#userDeviceCharts"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#satisfactionRate"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#dailyVisitInsightsChart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#subscriptionDistribution"),
  options
);
chart.render();
