...
const getDefaultEvents = () => {
  ...
  return [
    ...
    },
    {
      ...
      className:
        "!text-sky-500 w-[100%] !bg-sky-100 dark:!bg-sky-500/20 border-none rounded-md py-1.5 px-3",
    },
    {
      id: 999,
...
weekNumberCalendar.addEventListener("change", () =>
  calendar.setOption("weekNumbers", weekNumber())
);
...
const calendar = new FullCalendar.Calendar(calendarEl, {
  ...
  drop: (info) =>
    checkbox.checked && info.draggedEl.parentNode.removeChild(info.draggedEl),
