...
function eventListenerDropdown1(event, subitem, item, place) {
  ...
  var popper = Popper.createPopper(
    subitem,
    item.querySelector("#employeeTable .dropdown-menu"),
    {
      placement: place,
    }
  );
  ...
  if (subitem.classList.contains("show") != true) {
    item
      .querySelector("#employeeTable .dropdown-menu")
...
function dismissDropdownMenu() {
  Array.from(
    document.querySelectorAll("#employeeTable .dropdown-menu")
...
function updateDropdown() {
  setTimeout(() => {
    ...
    var elementsWithoutClickListener = Array.from(allElements).filter(function (
      element
    ) {
...
var employeeList = [
  ...
  },
  {
    ...
    Email: "PatriciaJGarcia@example.com",
    Phone: "077 7317 7572",
    Country: "Brazil",
    Experience: "0.5 Year",
  ...
  },
  {
    ...
    Email: "TonyaEJohnson@example.com",
    Phone: "079 2383 2340",
    Country: "Denmark",
    Experience: "0 Year",
  ...
  },
  {
    ...
    Email: "JulietteFecteau@example.com",
  ...
  },
  {
    ...
    Email: "HollyKavanaugh@example.com",
    Phone: "819 947 5846",
    Country: "Canada",
    Experience: "2.3 Year",
...
// employee Table get
var employeeTable = new List("employeeTable", options).on(
  "updated",
  function (list) {
    ...
    const totalRecordsElement =
      employeeTable.listContainer.querySelector(".total-records");
    const showingElement =
      employeeTable.listContainer.querySelector(".showing");

    if (totalEmploysElement)
      totalEmploysElement.innerHTML = employeeTable.items.length;
    if (totalRecordsElement)
      totalRecordsElement.innerHTML = employeeTable.items.length;

    if (showingElement)
      showingElement.innerHTML = employeeTable.visibleItems.length;
    document
...
function loadFileData(datas) {
  ...
  employeeTable.remove(
    "ID",
    `<a href="#!" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">#TWE1001501</a>`
  );
...
function paginationUpdateLink() {
  ...
  var pageLinks = document.querySelectorAll(
    "#employeeTable .listjs-pagination .page"
  );
...
function refreshCallbacks() {
    ...
    elem.addEventListener("click", function (e) {
      ...
      Array.from(itemValues).forEach(function (x) {
        ...
        if (selectedId == itemId) {
          ...
          document.getElementById("addEmployeeLabel").innerHTML =
            "Edit Employee Data";
          document
  ...
  Array.from(document.querySelectorAll(".remove-item-btn")).forEach(function (
    ...
    btn.addEventListener("click", function (e) {
      ...
      Array.from(itemValues).forEach(function (x) {
        var deleteid = new DOMParser().parseFromString(
          x._values.ID,
          "text/html"
        );
