                ...
                <div class="card-body !px-2.5">
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-12 2xl:grid-cols-12">
                        ...
                        <div class="lg:col-span-10 2xl:col-span-9">
                            <h5 class="mb-1">Example <i data-lucide="badge-check" class="inline-block size-4 text-sky-500 fill-sky-100 dark:fill-custom-500/20"></i></h5>
                                        ...
                                        <table class="w-full ltr:text-left rtl:ext-right">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-2 text-right text-slate-500 dark:text-zink-200"><a href="http://example.com/" target="_blank" class="text-custom-500">www.example.com</a></td>
                                                </tr>
                                                <tr>
                                                    <th class="py-2 font-semibold ps-0" scope="row">Email</th>
                                                    <td class="py-2 text-right text-slate-500 dark:text-zink-200">paula@Example.com</td>
                                                </tr>
                                                <tr>
                        ...
                        <table class="w-full align-middle border-separate whitespace-nowrap border-spacing-y-1">
                            ...
                            <tbody>
                                <tr class="bg-white dark:bg-zink-700">
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-transparent"> Docs File</td>
                                ...
                                <tr class="bg-white dark:bg-zink-700">
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-transparent"> Design Kit.psd</td>
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-transparent">Example</td>
                                    <td class="px-3.5 py-2.5 border-y border-transparent"><span class="ppx-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent">Successful</span></td>
                                    <td class="px-3.5 py-2.5 border-y border-transparent">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="#!" class="flex items-center justify-center transition-all duration-150 ease-linear rounded-md size-8 bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500"><i data-lucide="eye" class="size-3"></i></a>
                                ...
                                <tr class="bg-white dark:bg-zink-700">
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-transparent"> Guide Video.mp4</td>
                    ...
                    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 2xl:grid-cols-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    <h6 class="mb-1 text-16"><a href="#!"> Design</a></h6>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">floral12@mail.com</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">jameslash@mail.com</p>
                                        <p>+210 85 383 2388</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">angusgarnsey@mail.com</p>
                                        <p>+210 41521 1325</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">matildamarston@mail.com</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">zacharybenjamin@mail.com</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">rubychomley@mail.com</p>
                                        <p>+120 1234 56789</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">jessedouard@mail.com</p>
                                        <p>+87 044 017 3869</p>
                        ...
                        <div class="relative card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="text-slate-500 dark:text-zink-200">
                                        <p class="mb-1">xavierbower@mail.com</p>
                                        <p>+159 98765 32451</p>
