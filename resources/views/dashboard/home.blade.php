        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                <div class="col-span-12 md:order-1 xl:col-span-8 2xl:col-span-6">
                    <h5 class="mb-2">Welcome Example 🎉</h5>
                    <p class="mb-5 text-slate-500 dark:text-zink-200">The salary of<a href="#!" class="underline text-slate-800 dark:text-zink-50"> Example</a> is pending since 05 Dec, 2024. the documentation of the tasks, workflows, and activities that make up a process managed by the HR or People Ops team. <a href="#!" class="text-red-500">Learn More</a></p>
                </div>
                                        ...
                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div class="flex gap-2">
                                                ...
                                                <div class="grow">
                                                    ...
                                                    <p class="text-slate-500 dark:text-zink-200">kredden@mail.com</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div class="flex gap-2">
                                                ...
                                                <div class="grow">
                                                    <h6>Howard George</h6>
                                                    <p class="text-slate-500 dark:text-zink-200">george@mail.com</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div class="flex gap-2">
                                                ...
                                                <div class="grow">
                                                    <h6>Laura Carlson</h6>
                                                    <p class="text-slate-500 dark:text-zink-200">carlson15@mail.com</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                            <div class="flex gap-2">
                                                ...
                                                <div class="grow">
                                                    ...
                                                    <p class="text-slate-500 dark:text-zink-200">joseph@mail.com</p>
                                                </div>
                                            </div>
                                        </td>
                            ...
                            <div class="flex flex-col gap-3">
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="text-slate-500 dark:text-zink-200">james@mail.com</p>
                                        </div>
                                        <div class="relative dropdown shrink-0">
                                ...
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        ...
                                        <div class="grow">
                                            <h6 class="mb-1"><a href="#!">Example</a></h6>
                                            <p class="text-slate-500 dark:text-zink-200">example@mail.com</p>
                                        </div>
                                        <div class="relative dropdown shrink-0">
                                ...
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="text-slate-500 dark:text-zink-200">ledford@mail.com</p>
                                        </div>
                                        <div class="relative dropdown shrink-0">
                                ...
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="text-slate-500 dark:text-zink-200">gap-4@mail.com</p>
                                        </div>
                                        <div class="relative dropdown shrink-0">
