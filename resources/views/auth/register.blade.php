    ...
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <p class="text-slate-500 dark:text-zink-200">Get your free Application account now</p>
            </div>
            ...
            <form action="{{ route('register') }}" class="mt-10" method="POST">
                ...
                <p class="italic text-15 text-slate-500 dark:text-zink-200">By registering you agree to the Application <a href="#!" class="underline">Terms of Use</a></p>
                <div class="mt-10">
